...
from .buttons import CollectStats, SelectProject, StartLogin, LoginManager, Logout
from .timers import process_stats_queue, count_time


def register():
    bpy.utils.register_class(CollectStats)
    bpy.utils.register_class(SelectProject)
...
def unregister():
    ...
    bpy.utils.unregister_class(SelectProject)
